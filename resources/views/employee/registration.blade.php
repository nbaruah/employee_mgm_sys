...
<div class="panel-body">
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control input-sm" id="emp_id" name="emp_id" required>
    </div>
    <div class="form-group col-md-3">
      <label for="dob" class="col-form-label small">Date of Birth</label>
      <input type="text" class="form-control input-sm" id="dob" name="dob" required>
    </div>
    <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control input-sm" id="blood_group" name="blood_group">
    </div>
  </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control input-sm" id="pan" name="pan">
    </div>
    <div class="form-group col-md-4">
      <label for="adhar" class="col-form-label small">Adhar</label>
      <input type="text" class="form-control input-sm" id="adhar" name="adhar">
    </div>
  </div>
</div>
</div>
...
<div class="panel-body">
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control input-sm" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
    </div>
    <div class="form-group col-md-4">
  ...
  <div class="form-row">
    <div class="form-group col-md-5">
      ...
      <textarea class="form-control input-sm" name="present_add" rows="4" cols="20" id="present_add" placeholder="Present Address"></textarea>
    </div>
    ...
    <div class="form-group col-md-5">
      ...
      <textarea class="form-control input-sm" name="permanent_add" rows="4" cols="20" id="permanent_add" placeholder="Permanent Address"></textarea>
    </div>
  </div>
</div>
</div>
